...
namespace AssessmentTool\CarbonFields;
...
class CarbonFieldsServiceProvider implements ServiceProviderInterface {
	...
	protected function registerThemeOptions() {
		Container::make( 'theme_options', __( 'Theme Options', 'assessment_tool' ) )
			->set_page_file( 'assessment_tool-theme-options.php' )
			->add_fields( array(
				Field::make( 'text', 'crb_google_maps_api_key', __( 'Google Maps API Key', 'assessment_tool' ) ),
				Field::make( 'header_scripts', 'crb_header_script', __( 'Header Script', 'assessment_tool' ) ),
				Field::make( 'footer_scripts', 'crb_footer_script', __( 'Footer Script', 'assessment_tool' ) ),
			) );
	}
	...
	protected function registerPostMeta() {
		/*
		Container::make( 'post_meta', __( 'Custom Data', 'assessment_tool' ) )
	...
	protected function registerTermMeta() {
		/*
		Container::make( 'term_meta', __( 'Custom Data', 'assessment_tool' ) )
	...
	protected function registerUserMeta() {
		/*
		Container::make( 'user_meta', __( 'Custom Data', 'assessment_tool' ) )
			->add_fields( array(
				Field::make( 'image', 'crb_img' ),
			));
		*/
	...
	public function registerWidgets() {
		register_widget( \AssessmentTool\Widgets\Carbon_Rich_Text_Widget::class );
	}
}
